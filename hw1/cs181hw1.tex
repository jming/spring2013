...
\begin{enumerate}
	...
	\item Analyze the effectiveness of boosting:
		\begin{enumerate}
			...
			\item Comparing cross-validated training and test performance for boosting with weak learners of depth 1 over a number of rounds in [1, 15].
			$$\includegraphics[width=150mm]{nguyen-ming-3D.pdf}$$
			Training and test performance seem to be closely related in that performance for both over increasing number of rounds seem to move in very similar patterns. However the test data seems to reflect changes in performance more extremely than the training data.
		\end{enumerate}
	\end{enumerate}
\end{enumerate}
