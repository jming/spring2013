...
class NetworkFramework(object):
    ...
    def Train(self, images, validation_images, test_images, learning_rate, epochs):
        ...
        for i in range(epochs):
            ...
            print [perf_train for perf_train,y in performance_log]
            print [perf_validate for x,perf_validate in performance_log]

#            if perf_validate <= best_val_perf:
#                counter += 1
#            else:
#                best_val_perf = perf_validate
#                counter = 0
#            if counter == 5:
#                break
